    ...
    children: [
...

      {
        ...
        children: [
          ...
          //衛服部專用表單
          { path: 'HealthyHabits', name: 'HealthyHabits', component: () => import('@/views/main/Documents/Mohw/HealthyHabits/index.vue') },
          { path: 'MedicalHistories', name: 'MedicalHistories', component: () => import('@/views/main/Documents/Mohw/MedicalHistories/index.vue') },
          { path: 'DrugSafeties', name: 'DrugSafeties', component: () => import('@/views/main/Documents/Mohw/DrugSafeties/index.vue') },
          ...
          { path: 'BSRS5s', name: 'BSRS5s', component: () => import('@/views/main/Documents/Mohw/BSRS5s/index.vue') },
          { path: 'MNASFs', name: 'MNASFs', component: () => import('@/views/main/Documents/Mohw/MNASFs/index.vue') },
          { path: 'PainEvaluations', name: 'PainEvaluations', component: () => import('@/views/main/Documents/Mohw/PainEvaluations/index.vue') },
          { path: 'SOFs', name: 'SOFs', component: () => import('@/views/main/Documents/Mohw/SOFs/index.vue') },
...
// })
const router = createRouter({
  history: createWebHistory('/daycare/'),
  routes,
})
