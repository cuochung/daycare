<template>
  <div class="fall-event-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="fall-event-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="fall-event-list__title mb-1">跌倒事件分析登記表</h2>
                  <p class="fall-event-list__subtitle mb-0">
                    記錄住民跌倒事件，包含基本資料、跌倒特性分析、身體傷害等評估項目。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="fall-event-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <FallEventAdd ref="addDialogRef" :useDataBase="useDataBase" :items="items" @refresh="getAllData"
