...
<script>
import popupadd from "@/views/document/mohw/Dementias/Add";
...
export default {
  ...
  methods: {
    ...
    dataToJson(postItem) {
      ...
      let finalPostData = mohwFn.returnDementiasJSON(postData)
      ...
      finalObj['Dementias'] = finalPostData //設置指定的資料內容
    ...
    //計算總分數 (有備註qq12視為未評估，分數為0)
    calculateTotalScore(item) {
      if (item.qq12) { return 0 }
      let total = 0;
