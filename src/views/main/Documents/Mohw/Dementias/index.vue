<template>
  <div class="dementias-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="dementias-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="dementias-list__title mb-1">認知功能評估</h2>
                  <p class="dementias-list__subtitle mb-0">
                    評估住民認知功能狀況，包含時間、地點、記憶等十一項評估。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="dementias-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <DementiasAdd ref="addDialogRef" :useDataBase="useDataBase" @refresh="getAllData" />
            </v-card-title>
            <v-card-text>
...
import DementiasAdd from './Add.vue'
import mohwFn from '@/assets/js/mohwFn'

const store = useStore()
const { proxy } = getCurrentInstance()

const useDataBase = 'dementias'
const items = ref([])
const searchKey = ref('')
...
const calculateTotalScore = (item) => {
  if (!item) return 0
  if (item.qq12) return 0 // 有備註視為未評估
  let total = 0
  const questions = ['qq1', 'qq2', 'qq3', 'qq4', 'qq5', 'qq6', 'qq7', 'qq8', 'qq9', 'qq10', 'qq11']
