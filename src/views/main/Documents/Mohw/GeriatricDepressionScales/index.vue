<template>
  <div class="GeriatricDepressionScalesList">
    <v-card class="mt-2">
      <v-card-title>
        <v-row>
          <v-col cols="12" md="8">
...
<script>
import popupadd from "@/views/document/mohw/GeriatricDepressionScales/Add";
...
export default {
  ...
  data() {
    return {
      useDataBase: 'geriatricdepressionscales',
      items: [], //目前讀取進來的資料庫
      searchKey: "",
  ...
  methods: {
    ...
    dataToJson(postItem) {
      ...
      let finalPostData = mohwFn.returnGeriatricDepressionScalesJSON(postData)
      ...
      finalObj['GeriatricDepressionScales'] = finalPostData //設置指定的資料內容
      ...
      //       Dementias: [],
      //       BSRS5s: [],
      //       GeriatricDepressionScales: [finalPostData],
      //       MNASFs: [],
      //       PainEvaluations: [],
      //       SOFs: [],
      //     },
