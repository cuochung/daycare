<template>
  <div class="mnasfs-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="mnasfs-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="mnasfs-list__title mb-1">簡易營養評估</h2>
                  <p class="mnasfs-list__subtitle mb-0">
                    評估住民營養狀況，包含食慾、體重變化、行動力等評估項目。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mnasfs-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <MNASFsAdd ref="addDialogRef" :useDataBase="useDataBase" @refresh="getAllData" />
            </v-card-title>
            <v-card-text>
...
import MNASFsAdd from './Add.vue'
import mohwFn from '@/assets/js/mohwFn'

const store = useStore()
const { proxy } = getCurrentInstance()

const useDataBase = 'mnasfs'
const items = ref([])
const searchKey = ref('')
