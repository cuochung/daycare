<template>
  <div class="fall-risks-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="fall-risks-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="fall-risks-list__title mb-1">跌倒危險性評估</h2>
                  <p class="fall-risks-list__subtitle mb-0">
                    評估住民跌倒風險，包含年紀、過去跌倒史、意識認知等八項評估。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="fall-risks-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <FallRisksAdd ref="addDialogRef" :useDataBase="useDataBase" @refresh="getAllData" />
            </v-card-title>
            <v-card-text>
...
import FallRisksAdd from './Add.vue'
import mohwFn from '@/assets/js/mohwFn'

const store = useStore()
const { proxy } = getCurrentInstance()

const useDataBase = 'fallrisks'
const items = ref([])
const searchKey = ref('')
