<template>
  <div class="bsrs5s-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="bsrs5s-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="bsrs5s-list__title mb-1">簡式健康量表評估</h2>
                  <p class="bsrs5s-list__subtitle mb-0">
                    評估住民心理健康狀況，包含睡眠、緊張、憂鬱等六項評估。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bsrs5s-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <BSRS5sAdd ref="addDialogRef" :useDataBase="useDataBase" @refresh="getAllData" />
            </v-card-title>
            <v-card-text>
...
import BSRS5sAdd from './Add.vue'
import mohwFn from '@/assets/js/mohwFn'

const store = useStore()
const { proxy } = getCurrentInstance()

const useDataBase = 'bsrs5s'
const items = ref([])
const searchKey = ref('')
