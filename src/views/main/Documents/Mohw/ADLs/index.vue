<template>
  <div class="adls-list">
    <v-container fluid class="pa-0">
      <v-row>
        <v-col cols="12">
          <v-sheet class="adls-list__hero" rounded="xl" elevation="0">
            <div class="d-flex flex-column flex-md-row justify-space-between align-start">
              <div class="d-flex align-center mb-4 mb-md-0">
                ...
                <div>
                  <h2 class="adls-list__title mb-1">日常生活功能評估</h2>
                  <p class="adls-list__subtitle mb-0">
                    評估住民日常生活自理能力，包含進食、移位、衛生等十項功能評估。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="adls-list__meta d-flex flex-wrap ga-3">
        ...
        <v-col cols="12">
          <v-card>
            <v-card-title class="d-flex align-center">
              ...
              <ADLsAdd ref="addDialogRef" :useDataBase="useDataBase" @refresh="getAllData" />
            </v-card-title>
            <v-card-text>
...
import ADLsAdd from './Add.vue'
import mohwFn from '@/assets/js/mohwFn'

const store = useStore()
const { proxy } = getCurrentInstance()

const useDataBase = 'adls'
const items = ref([])
const searchKey = ref('')
...
const calculateTotalScore = (item) => {
  if (!item) return 0
  let total = 0
  const questions = ['qq1', 'qq2', 'qq3', 'qq4', 'qq5', 'qq6', 'qq7', 'qq8', 'qq9', 'qq10']
