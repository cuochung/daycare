<template>
  <div class="PressureInjuriesList">
    <v-card class="mt-2">
      <v-card-title>
        <v-row>
          <v-col cols="12" md="8">
...
<script>
import popupadd from "@/views/document/mohw/PressureInjuries/Add";
...
export default {
  ...
  methods: {
    ...
    dataToJson(postItem) {
      ...
      let finalPostData = mohwFn.returnPressureInjuriesJSON(postData)
      ...
      finalObj['PressureInjuries'] = finalPostData //設置指定的資料內容
      ...
      //       DrugSafeties: [],
      //       BodyEvaluations: [],
      //       PressureInjuries: [finalPostData],
      //       FallRisks: [],
      //       ADLs: [],
      //       IADLs: [],
      //       Dementias: [],
