...
<script>
import popupadd from "@/views/document/mohw/PainEvaluations/Add";
...
export default {
  ...
  methods: {
    ...
    dataToJson(postItem) {
      ...
      let finalPostData = mohwFn.returnPainEvaluationsJSON(postData)
      ...
      finalObj['PainEvaluations'] = finalPostData //設置指定的資料內容
